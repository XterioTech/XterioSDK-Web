import{t as O,r as Q,g as K}from"./unicode-JQcmJgeo.js";import{K as Y}from"./chunk-HNT3GIR6-ajhc_dYH.js";import{N as q}from"./chunk-XOADOAIQ-DVldJ8t3.js";import{p as j}from"./chunk-3ESANLHR-B62uylix.js";import{N as G}from"./chunk-2EPM6PV4-BaNefixp.js";import{X as M,r as o,s as H,h as P,o as n,B as U,ae as V,d as Z,l as ee,m as X,N as te,u as ne,D as L,af as oe}from"./index-BD23dcPj.js";import{u as ae}from"./index-C5MDf7J-.js";import{u as D}from"./useRequest-BKQSp_75.js";import{B as re}from"./throttle-phYxD10V.js";import{u as W}from"./useTranslation-BoK6yStg.js";import{R as ie}from"./DownOutlined-TcG62Ziz.js";import"./index-Capczc9u.js";import"./index-BvUCe6rd.js";import"./debounce-4ilRyqxH.js";import"./isObject-CrIk3fyR.js";var J=`.set-email-container {
  position: relative;
  display: flex;
...
`,ce=B=>{let{bindAccount:c,backToInputAccount:r,redirectUrl:a="",verifyToken:E=""}=B,$=q(),{t:l}=W(),{themeType:_,language:f}=H(),d=M(),[s,N]=o.useState(""),[C,g]=o.useState(1e3),[i,b]=o.useState(60),[u,x]=o.useState(),A=o.useRef(null),{authCoreModal:I}=P(),[m,v]=o.useState(!1);ae(()=>{if(i>0){let t=i-1;b(t),t===0&&g(void 0)}},C);let{run:h}=D(oe,{manual:!0,onBefore:()=>{v(!0)},onSuccess:t=>{te(),a?d(a.split("?")[0],{replace:!0,back:!0,state:{...ne.parse(a.split("?")[1]),verifyToken:t==null?void 0:t.token,account:c}}):t.has_set_payment_password?d("/account/security",{replace:!0}):d("/account/set-password")},onError:t=>{(t==null?void 0:t.error_code)===L.InvalidCode?x(l("login.invalid_code")):(t==null?void 0:t.error_code)===L.ResendCode&&x(l("login.please_send_again"))},onFinally:()=>{setTimeout(()=>{v(!1)},2e3)}}),{loading:y,run:w}=D(V,{manual:!0,onSuccess:(t,p)=>{C||(b(60),g(1e3))},onError:t=>{b(0),g(void 0)}}),S=t=>{let p;c.includes("@")?p={email:c,code:t||s}:p={phone:c,code:t||s},E&&(p.token=E),h(p)},z=()=>{x(""),c.includes("@")?w({email:c}):X({theme:_,language:f,getContainer:()=>I.rootBody}).then(t=>{w({phone:c,cf_turnstile_response:t})}).catch(t=>{$.error(l("error.server_20112"))})},k=t=>{N(t),x(""),t.length===6&&R(t)},R=o.useCallback(re(t=>{S(t)},1e3,{leading:!0,trailing:!1}),[]);o.useEffect(()=>{var t;let p=document.getElementsByClassName("react-input-code"),F=T=>T.preventDefault();return(t=p[0])==null||t.addEventListener("contextmenu",F),()=>{var T;(T=p[0])==null||T.removeEventListener("contextmenu",F)}},[]);let e=()=>{var t;(t=document.getElementsByClassName("input-code-item")[Math.min(s.length,5)])==null||t.focus()};return n.createElement("div",{className:"set-email-container"},n.createElement("style",null,J),n.createElement(j,{className:"icon-navigation-back",name:"circle_back",onClick:r}),n.createElement("h2",{className:"set-email-title"},l("account.enter_code")),n.createElement("p",{className:"set-email-desc-2",style:{margin:20}},c),n.createElement("div",{onClick:e},n.createElement(Y,{containerClassName:"react-input-code",inputClassName:"input-code-item",allowedCharacters:"numeric",length:6,ref:A,placeholder:" ",onChange:k})),u&&n.createElement("div",{className:"code-error"},u),n.createElement(U,{disabled:s.length!==6,className:"account-submit-btn",loading:m,onClick:()=>S()},l("common.confirm")),n.createElement(U,{className:"send-again",onClick:z,disabled:i>0||y},i>0?`${l("login.send_again")} (${i}s)`:l("login.send_again")),n.createElement("div",{className:"back",onClick:r},n.createElement(j,{className:"arrow1-icon",name:"arrow1_icon"}),n.createElement("span",null,l("login.back"))),n.createElement(G,null))},le=ce,se=B=>{let c=M(),{t:r}=W(),a=B,E=a==null?void 0:a.redirectUrl,$=a==null?void 0:a.verifyToken,l=q(),_=o.useRef(),[f,d]=o.useState(""),[s,N]=o.useState(["United States","us","1"]),[C,g]=o.useState(!1),i=o.useRef(null),[b,u]=o.useState(""),{themeType:x,language:A}=H(),{authCoreModal:I}=P(),[m,v]=o.useState("email");o.useEffect(()=>{if(m==="phone"||a!=null&&a.showSwitch){let e=O();e&&N(e)}},[m,a==null?void 0:a.showSwitch]);let[h,y]=o.useState(!1);o.useEffect(()=>{if(h)return document.addEventListener("click",w,!0),()=>{document.removeEventListener("click",w,!0)}},[h]);let w=e=>{setTimeout(()=>{var t;(t=_.current)!=null&&t.contains(e.target)||y(!1)})};o.useEffect(()=>{let e=a==null?void 0:a.accountType;e&&v(e)},[a]);let{loading:S,run:z}=D(V,{manual:!0,onSuccess:(e,t)=>{g(e)},onError:e=>{let t=(e==null?void 0:e.error_code)||0;(t===50003||t===50004)&&(d(""),i.current.value="")}}),k=()=>{let e=i.current.value;if(m==="email")if(e){if(!Z.test(e))return u(r("login.email_format_error"))}else return u(r("account.input_vaild_email"));else{let t=s[1].toUpperCase();if(!e&&e!=="0")return u(r("account.input_vaild_mobile"));if(ee(e,t))e=`+${s[2]}${e}`;else return u(r("login.phone_format_error"))}d(e),e.includes("@")?z({email:e}):X({theme:x,language:A,getContainer:()=>I.rootBody}).then(t=>{z({phone:e,cf_turnstile_response:t})}).catch(t=>{l.error(r("error.server_20112"))})},R=()=>{u(""),v(m==="email"?"phone":"email"),d("")};return o.useEffect(()=>{setTimeout(()=>{var e;(e=i.current)==null||e.focus()})},[]),C?n.createElement(le,{bindAccount:f,redirectUrl:E||"",verifyToken:$,backToInputAccount:()=>{g(!1)}}):n.createElement("div",{className:"set-email-container"},n.createElement("style",null,J),n.createElement(j,{className:"icon-navigation-back",name:"circle_back",onClick:()=>c(-1)}),n.createElement("h2",{className:"set-email-title"},r(m==="email"?"account.set_your_email":"account.set_your_mobile")),n.createElement("p",{className:"set-email-desc-1"},r(m==="email"?"account.set_your_email_tip":"account.set_your_mobile_tip")),m==="email"?n.createElement(n.Fragment,null,n.createElement("div",{className:"account-input-box"},n.createElement("input",{onInput:()=>u(""),className:"input_email",type:"email",placeholder:r("account.place_email_address"),ref:i,defaultValue:f,onKeyDown:e=>{e.key==="Enter"&&k()}}))):n.createElement(n.Fragment,null,n.createElement("div",{className:"account-input-box phone",ref:_},h&&n.createElement("div",{className:"account-select-country"},Q.map((e,t)=>n.createElement("p",{key:t,className:"account-select-country-item",onClick:()=>{N(e),y(!1)}},n.createElement("div",{className:"country-box"},n.createElement("div",{className:"country-flag"},K(`${e[1]}`)),n.createElement("span",{className:"country-name"},e[0])),n.createElement("div",{className:"country-code"},"+"+e[2])))),n.createElement("div",{className:"account-select-opt",onClick:()=>y(!h)},n.createElement("div",{className:"account-select-icon"},K(`${s[1]}`)),n.createElement(ie,{className:"down-more"})),n.createElement("span",null,"+",s[2]),n.createElement("input",{onInput:()=>{var e;u(""),i.current.value=((e=i.current.value.match(/^\d+/))==null?void 0:e[0])||""},type:"text",className:"no-number dd",placeholder:r("account.mobile"),ref:i,onWheel:e=>e.target.blur(),defaultValue:f.replace(`+${s[2]}`,""),onKeyDown:e=>{e.key==="Enter"&&k()},onFocus:()=>{var e;(e=document.querySelector(".account-input-box.phone"))==null||e.setAttribute("data-focus","true")},onBlur:()=>{var e;(e=document.querySelector(".account-input-box.phone"))==null||e.setAttribute("data-focus","false")}}))),n.createElement("p",{className:`error-tip ${b?"show":""}`},b),n.createElement(U,{className:"send-code-btn account-submit-btn bottom-margin",loading:S,onClick:k},r("login.get_captcha")),(a==null?void 0:a.showSwitch)&&n.createElement("div",{className:"account-switch-item",onClick:R},r(m==="email"?"account.switch_text_mobile":"account.switch_text_email")),n.createElement(G,null))},Ne=se;export{Ne as default};
