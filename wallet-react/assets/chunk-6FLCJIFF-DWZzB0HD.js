...
`,N=({onChange:i,value:r,keyboardInvisible:c})=>{let{t:m}=h(),[k,W]=o.useState(["","","","","",""]),[t,l]=o.useState(r??""),[b,X]=o.useState([1,2,3,4,5,6,7,8,9,"",0]),w=a=>{t.length<6&&l(t+""+a)},g=()=>{if(t.length>0){let a=t.slice(0,t.length-1);l(a)}};return o.useEffect(()=>{i==null||i(t)},[t]),o.useEffect(()=>{l(r??"")},[r]),c?e.createElement(e.Fragment,null,e.createElement("style",null,d),e.createElement("div",{className:"particle-keywords-map loading"},e.createElement("img",{src:(E(),x(s)).default,alt:""}),e.createElement("p",null,m("account.payment_checking")),e.createElement(A,{className:"loading-icon"}))):e.createElement(e.Fragment,null,e.createElement("style",null,d),e.createElement("div",{className:"particle-keywords-box"},k.map((a,n)=>e.createElement("span",{key:a+n,className:`input-item ${!a||"active"}`},t[n]?"●":""))),e.createElement("div",{className:"particle-keywords-map"},b.map(a=>e.createElement("span",{className:"span",key:a,"data-value":a,onClick:()=>{a!==""&&w(a+"")}},a)),e.createElement("span",{className:"span del",onClick:g},e.createElement(y,{className:"img",name:"backspace"})),e.createElement(u,null)))},z=N;export{z as Q};
