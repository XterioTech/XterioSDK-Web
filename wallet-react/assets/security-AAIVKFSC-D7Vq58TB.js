import{z as W}from"./chunk-YV2QPNMZ-BTVn5vT5.js";import{N as Y}from"./chunk-BOXSB6AN-pkQAMqsR.js";import{w as z}from"./chunk-IBLFF4W2-iS6mzBtV.js";import{p}from"./chunk-3WXPHVZ4-Bi1PhCbS.js";import{N as q}from"./chunk-6X7TBCV3-xs5bAmgU.js";import{J as D,r as l,L as H,E as X,F as Z,H as Q,I as ee,A as C,M,o as e,N as T,G as te,l as ae,m as ce,Y as oe,W as ne,R as re,n as B,O as ie,p as le,B as se,K as ue,V as me,P as de,S as pe,T as ve,v as he,X as ye,Z as be,t as P}from"./index-D1UfBkzM.js";import{u as j}from"./useTranslation-kryGy5SU.js";var ge=`.bind-security-account-prompt .ant-modal-content {
  padding: 18px;
}
...
`,_e=()=>{var v,h,m,y,s;let{t:a}=j(),n=D(),[V,b]=l.useState(!1),{setPaymentVerify:$,showSelectSecurityAccount:A,setPaymentPassword:S}=H(),{userInfo:t}=X(),{modalOptions:I}=Z(),g=Y(),x=l.useMemo(()=>Q(),[t]),w=o=>{var c;return((c=t==null?void 0:t.thirdparty_user_info)==null?void 0:c.provider)===C.jwt?o==null?void 0:o.replace(`${I.projectId}:`,""):o},U={email:me,phone:ue,facebook:se,google:le,apple:ie,twitter:B,twitterv1:B,discord:re,github:ne,twitch:oe,microsoft:ce,linkedin:ae,jwt:te,telegram:W},u=l.useMemo(()=>{var o;let c=ee();return c||(c=((o=t==null?void 0:t.thirdparty_user_info)==null?void 0:o.provider)||"email"),c==="twitterv1"&&(c=C.twitter),c},[t]),F=l.useMemo(()=>{var o,c,r,i;let d="";return u&&t&&(d=t[`${u}`]||t[`${u}_email`]||M(w(t[`${u}_id`]))),d||(t==null?void 0:t.email)||(t==null?void 0:t.phone)||((c=(o=t==null?void 0:t.thirdparty_user_info)==null?void 0:o.user_info)==null?void 0:c.email)||M(w(((i=(r=t==null?void 0:t.thirdparty_user_info)==null?void 0:r.user_info)==null?void 0:i.id)||""))},[u,t]),f=o=>{var c,r,i,d,N,k;(c=t==null?void 0:t.security_account)!=null&&c.email&&!((r=t==null?void 0:t.security_account)!=null&&r.phone)||!((i=t==null?void 0:t.security_account)!=null&&i.email)&&((d=t==null?void 0:t.security_account)!=null&&d.phone)?n("/account/verify",{state:{account:((N=t==null?void 0:t.security_account)==null?void 0:N.email)||((k=t.security_account)==null?void 0:k.phone),authType:o,redirectUrl:"/account/security",pageType:"verify_security_account_set_security_account"}}):n("/account/bind",{state:{accountType:o,redirectUrl:"/account/security"}})},L=()=>{var o,c,r,i;(o=t==null?void 0:t.security_account)!=null&&o.email&&((c=t==null?void 0:t.security_account)!=null&&c.phone)?A(!0):n("/account/set-password",{state:{account:((r=t==null?void 0:t.security_account)==null?void 0:r.email)||((i=t==null?void 0:t.security_account)==null?void 0:i.phone)}})},O=()=>{$({visible:!0,type:"close",onVerifyCompleted:o=>{ve(o).then(c=>{g.success(a("account.close_success")),T()}).catch(c=>{c.message&&g.error(c.message)})}})},_=l.useMemo(()=>!0,[]),R=()=>{n(-1)},G=()=>{n("/account/master-password/change")},J=()=>{n("/account/master-password")},K=()=>{n("/account/master-password/description")},E=l.useMemo(()=>{var o,c;return((o=t==null?void 0:t.security_account)==null?void 0:o.email)||((c=t==null?void 0:t.security_account)==null?void 0:c.phone)},[(v=t==null?void 0:t.security_account)==null?void 0:v.email,(h=t==null?void 0:t.security_account)==null?void 0:h.phone]);return l.useEffect(()=>{T().catch(o=>{})},[]),e.createElement("div",{className:"account-and-security"},e.createElement("style",null,fe),_&&e.createElement(z,{onBack:R},a("account.account_and_security")),!_&&e.createElement(z,null,a("account.account_and_security")),e.createElement("div",{className:"scroll-content"},e.createElement("div",{className:"category-title"},a("account.account")),e.createElement("div",{className:"account-box"},e.createElement("img",{className:"account-avatar",src:U[u]}),e.createElement("div",{className:"account"},F),e.createElement("div",{className:"more-account",onClick:()=>{E?n("/login-account"):b(!0)}},a("account.more_login_account"))),e.createElement("div",{className:"payment-security authorization-item"},e.createElement("div",{className:"label-item hover",onClick:()=>{n("/manageDevices/deviceList")}},e.createElement("div",{className:"label-item-name"},a("new.authorization")),e.createElement(p,{className:"arrow-right-icon",name:"arrow_right_icon"}))),e.createElement("div",{className:"category-title"},a("account.security")),e.createElement("div",{className:"master-password-item"},e.createElement("div",{className:"mp-header"},e.createElement("div",{className:"mp-title"},a("account.master_password")),e.createElement("div",{className:"mp-learn-more",onClick:K},a("account.learn_more"))),e.createElement("div",{className:"mp-content"},e.createElement("div",{className:"mp-desc"},a("account.master_password_tip")),!x&&e.createElement("div",{className:"mp-set",onClick:J},a("account.set"))),x&&e.createElement("div",{className:"label-item hover",onClick:G},e.createElement("div",{className:"label-item-name"},a("account.change_master_password")),e.createElement(p,{className:"arrow-right-icon",name:"arrow_right_icon"}))),e.createElement("div",{className:"verification-security"},e.createElement("h3",null,a("account.verification_security")),e.createElement("p",null,a("account.verification_security_tip")),e.createElement("div",{className:"label-item"},e.createElement("div",{className:"label-item-name"},a("account.email")),de(((m=t==null?void 0:t.security_account)==null?void 0:m.email)||"")||e.createElement("div",{className:"label-item-btn",onClick:()=>f("email")},a("account.set"))),e.createElement("div",{className:"label-item"},e.createElement("div",{className:"label-item-name"},a("account.mobile")),pe(((y=t==null?void 0:t.security_account)==null?void 0:y.phone)||"")||e.createElement("div",{className:"label-item-btn",onClick:()=>f("phone")},a("account.set")))),e.createElement("div",{className:"payment-security"},e.createElement("h3",null,a("account.payment_security")),e.createElement("p",null,a("account.payment_password_hint")),(s=t==null?void 0:t.security_account)!=null&&s.has_set_payment_password?e.createElement(e.Fragment,null,e.createElement("div",{className:"label-item hover",onClick:()=>n("/account/change-password")},e.createElement("div",{className:"label-item-name"},a("account.change_payment_password")),e.createElement(p,{className:"arrow-right-icon",name:"arrow_right_icon"})),e.createElement("div",{className:"label-item hover",onClick:L},e.createElement("div",{className:"label-item-name"},a("account.forgot_payment_password")),e.createElement(p,{className:"arrow-right-icon",name:"arrow_right_icon"})),e.createElement("div",{className:"label-item hover",onClick:O},e.createElement("div",{className:"label-item-name"},a("account.close_payment_password")),e.createElement(p,{className:"arrow-right-icon",name:"arrow_right_icon"}))):e.createElement("div",{className:"label-item"},e.createElement("div",{className:"label-item-name"},a("account.payment_password")),e.createElement("div",{className:"label-item-btn",onClick:()=>{E?S():b(!0)}},a("account.set"))))),e.createElement(q,{className:"footer-box-v2"}),e.createElement(we,{visible:V,setVisible:b,onBind:()=>{n("/account/bind",{state:{accountType:t!=null&&t.email?"phone":"email",showSwitch:!0,redirectUrl:"/account/security"}})}}))},Be=_e;export{Be as default};
