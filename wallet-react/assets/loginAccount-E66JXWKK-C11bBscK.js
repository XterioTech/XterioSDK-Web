import{N as _}from"./chunk-BOXSB6AN-BOIspxoB.js";import{w}from"./chunk-IBLFF4W2-OOJ3lvIH.js";import{p as E}from"./chunk-3WXPHVZ4-cSmg91e_.js";import{N as k}from"./chunk-6X7TBCV3-eRBpL_zk.js";import{aQ as N,r as h,aR as T,aS as $,aT as O,A as s,K as S,V as A,w as j,v as z,x as B,p as K,J as C,L as I,o as c}from"./index-cUH_XrzV.js";import{B as J}from"./throttle-B2HzOfqO.js";import{u as L}from"./useTranslation-_iSjlM1q.js";function M(l,e){var o,r=N(l),u=(o=e==null?void 0:e.wait)!==null&&o!==void 0?o:1e3,t=h.useMemo(function(){return J(function(){for(var i=[],a=0;a<arguments.length;a++)i[a]=arguments[a];return r.current.apply(r,T([],$(i),!1))},u,e)},[]);return O(function(){t.cancel()}),{run:t,cancel:t.cancel,flush:t.flush}}var P=`.login-account-box {
  display: flex;
